 ...
 *
 *
 * Date:           Generated on         Thu May 21 17:24:25 2009
 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/chp/35130/rdb/a0/bchp_usb_ohci.h $
 * 
 * Hydra_Software_Devel/1   5/21/09 8:18p albertl
 ...
 ***************************************************************************/
#define BCHP_USB_OHCI_HcRevision                 0x00210400 /* Host Controller Revision Register */
#define BCHP_USB_OHCI_HcControl                  0x00210404 /* Host Controller Control Register */
#define BCHP_USB_OHCI_HcCommandStatus            0x00210408 /* Host Controller Command Status Register */
#define BCHP_USB_OHCI_HcInterruptStatus          0x0021040c /* Host Controller Interrupt Status Register */
#define BCHP_USB_OHCI_HcInterruptEnable          0x00210410 /* Host Controller Interrupt Enable Register */
#define BCHP_USB_OHCI_HcInterruptDisable         0x00210414 /* Host Controller Interrupt Disable Register */
#define BCHP_USB_OHCI_HcHCCA                     0x00210418 /* Host Controller Communication Area Register */
#define BCHP_USB_OHCI_HcPeriodCurrentED          0x0021041c /* Current Isochronous or Interrupt Endpoint Descriptor Register */
#define BCHP_USB_OHCI_HcControlHeadED            0x00210420 /* First Endpoint Descriptor of the Control List */
#define BCHP_USB_OHCI_HcControlCurrentED         0x00210424 /* Current Endpoint Descriptor of the Control List */
#define BCHP_USB_OHCI_HcBulkHeadED               0x00210428 /* First Endpoint Descriptor of the Bulk List */
#define BCHP_USB_OHCI_HcBulkCurrentED            0x0021042c /* Current Endpoint Descriptor of the Bulk List */
#define BCHP_USB_OHCI_HcDoneHead                 0x00210430 /* Last Completed Transfer Descriptor Added to the Done Queue */
#define BCHP_USB_OHCI_HcFmInterval               0x00210434 /* Frame Bit Time Interval Register */
#define BCHP_USB_OHCI_HcFmRemaining              0x00210438 /* Bit Time Remaining in the Current Frame */
#define BCHP_USB_OHCI_HcFmNumber                 0x0021043c /* Frame Number Register */
#define BCHP_USB_OHCI_HcPeriodicStart            0x00210440 /* Register to Start Processing the Periodic List */
#define BCHP_USB_OHCI_HcLSThreshold              0x00210444 /* LS Packet Threshold Register */
#define BCHP_USB_OHCI_HcRhDescriptorA            0x00210448 /* Root Hub Descriptor A Register */
#define BCHP_USB_OHCI_HcRhDescriptorB            0x0021044c /* Root Hub Descriptor B Register */
#define BCHP_USB_OHCI_HcRhStatus                 0x00210450 /* Root Hub Status Register */
#define BCHP_USB_OHCI_HcRhPortStatus1            0x00210454 /* Root Hub Port Status Register for Port 1 */
#define BCHP_USB_OHCI_HcRhPortStatus2            0x00210458 /* Root Hub Port Status Register for Port 2 */
