...
#if	defined(CONFIG_BCM7420A0)
static unsigned int k2_sata_mmio_data_xfer(struct ata_device *adev, unsigned char *buf,
...
static irqreturn_t __maybe_unused k2_sata_interrupt(int irq, void *dev_instance,
				   struct pt_regs *regs)
{
...
static struct ata_port_operations k2_sata_ops = {
	...
	// XXX .irq_handler		= k2_sata_interrupt,	

	.bmdma_setup		= k2_bmdma_setup_mmio,
	.bmdma_start		= k2_bmdma_start_mmio,
	.sff_tf_load		= k2_sata_tf_load,
#if	defined(CONFIG_BCM7420A0)
	.sff_data_xfer		= k2_sata_mmio_data_xfer,
#endif
#if 0
