...
#if   defined(CONFIG_BRCM_HAS_NAND_MAJOR_3) && defined(CONFIG_BRCM_HAS_NAND_MINOR_0)
#define CONFIG_MTD_BRCMNAND_VERSION		CONFIG_MTD_BRCMNAND_VERS_3_0
#elif defined(CONFIG_BRCM_HAS_NAND_MAJOR_3) && defined(CONFIG_BRCM_HAS_NAND_MINOR_1)
#ifdef CONFIG_BCM7601
#define CONFIG_MTD_BRCMNAND_VERSION		CONFIG_MTD_BRCMNAND_VERS_3_1_1
#else
#define CONFIG_MTD_BRCMNAND_VERSION		CONFIG_MTD_BRCMNAND_VERS_3_1_0
#endif
#elif defined(CONFIG_BRCM_HAS_NAND_MAJOR_3) && defined(CONFIG_BRCM_HAS_NAND_MINOR_2)
#define CONFIG_MTD_BRCMNAND_VERSION		CONFIG_MTD_BRCMNAND_VERS_3_2
#elif defined(CONFIG_BRCM_HAS_NAND_MAJOR_3) && defined(CONFIG_BRCM_HAS_NAND_MINOR_3)
#define CONFIG_MTD_BRCMNAND_VERSION		CONFIG_MTD_BRCMNAND_VERS_3_3
#endif
