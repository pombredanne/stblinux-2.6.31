...
#define BCHP_NAND_ONFI_STATUS                    0x00442888 /* ONFI Status */
#define BCHP_NAND_ONFI_DEBUG_DATA                0x0044288c /* ONFI Debug Data */
...
#define BCHP_NAND_ACC_CONTROL_CS1                0x004428d0 /* Nand Flash Access Control */
#define BCHP_NAND_CONFIG_CS1                     0x004428d4 /* Nand Flash Config */
#define BCHP_NAND_TIMING_1_CS1                   0x004428d8 /* Nand Flash Timing Parameters 1 */
#define BCHP_NAND_TIMING_2_CS1                   0x004428dc /* Nand Flash Timing Parameters 2 */
#define BCHP_NAND_ACC_CONTROL_CS2                0x004428e0 /* Nand Flash Access Control */
#define BCHP_NAND_CONFIG_CS2                     0x004428e4 /* Nand Flash Config */
#define BCHP_NAND_TIMING_1_CS2                   0x004428e8 /* Nand Flash Timing Parameters 1 */
#define BCHP_NAND_TIMING_2_CS2                   0x004428ec /* Nand Flash Timing Parameters 2 */
#define BCHP_NAND_ACC_CONTROL_CS3                0x004428f0 /* Nand Flash Access Control */
#define BCHP_NAND_CONFIG_CS3                     0x004428f4 /* Nand Flash Config */
#define BCHP_NAND_TIMING_1_CS3                   0x004428f8 /* Nand Flash Timing Parameters 1 */
#define BCHP_NAND_TIMING_2_CS3                   0x004428fc /* Nand Flash Timing Parameters 2 */
#define BCHP_NAND_SPARE_AREA_READ_OFS_10         0x00442930 /* Nand Flash Spare Area Read Bytes 16-19 */
#define BCHP_NAND_SPARE_AREA_READ_OFS_14         0x00442934 /* Nand Flash Spare Area Read Bytes 20-23 */
#define BCHP_NAND_SPARE_AREA_READ_OFS_18         0x00442938 /* Nand Flash Spare Area Read Bytes 24-27 */
#define BCHP_NAND_SPARE_AREA_READ_OFS_1C         0x0044293c /* Nand Flash Spare Area Read Bytes 28-31 */
#define BCHP_NAND_SPARE_AREA_WRITE_OFS_10        0x00442940 /* Nand Flash Spare Area Write Bytes 16-19 */
#define BCHP_NAND_SPARE_AREA_WRITE_OFS_14        0x00442944 /* Nand Flash Spare Area Write Bytes 20-23 */
#define BCHP_NAND_SPARE_AREA_WRITE_OFS_18        0x00442948 /* Nand Flash Spare Area Write Bytes 24-27 */
#define BCHP_NAND_SPARE_AREA_WRITE_OFS_1C        0x0044294c /* Nand Flash Spare Area Write Bytes 28-31 */
#define BCHP_NAND_LL_OP                          0x00442978 /* Nand Flash Low Level Operation */
#define BCHP_NAND_LL_RDDATA                      0x0044297c /* Nand Flash Low Level Read Data */
