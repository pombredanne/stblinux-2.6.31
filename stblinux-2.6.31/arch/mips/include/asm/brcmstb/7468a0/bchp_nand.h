 ...
 *
 *
 * Date:           Generated on         Fri Sep 11 15:18:19 2009
 ...
 ***************************************************************************/
#define BCHP_NAND_REVISION                       0x00312800 /* NAND Revision */
#define BCHP_NAND_CMD_START                      0x00312804 /* Nand Flash Command Start */
#define BCHP_NAND_CMD_EXT_ADDRESS                0x00312808 /* Nand Flash Command Extended Address */
#define BCHP_NAND_CMD_ADDRESS                    0x0031280c /* Nand Flash Command Address */
#define BCHP_NAND_CMD_END_ADDRESS                0x00312810 /* Nand Flash Command End Address */
#define BCHP_NAND_CS_NAND_SELECT                 0x00312814 /* Nand Flash EBI CS Select */
#define BCHP_NAND_CS_NAND_XOR                    0x00312818 /* Nand Flash EBI CS Address XOR with 1FC0 Control */
#define BCHP_NAND_SPARE_AREA_READ_OFS_0          0x00312820 /* Nand Flash Spare Area Read Bytes 0-3 */
#define BCHP_NAND_SPARE_AREA_READ_OFS_4          0x00312824 /* Nand Flash Spare Area Read Bytes 4-7 */
#define BCHP_NAND_SPARE_AREA_READ_OFS_8          0x00312828 /* Nand Flash Spare Area Read Bytes 8-11 */
#define BCHP_NAND_SPARE_AREA_READ_OFS_C          0x0031282c /* Nand Flash Spare Area Read Bytes 12-15 */
#define BCHP_NAND_SPARE_AREA_WRITE_OFS_0         0x00312830 /* Nand Flash Spare Area Write Bytes 0-3 */
#define BCHP_NAND_SPARE_AREA_WRITE_OFS_4         0x00312834 /* Nand Flash Spare Area Write Bytes 4-7 */
#define BCHP_NAND_SPARE_AREA_WRITE_OFS_8         0x00312838 /* Nand Flash Spare Area Write Bytes 8-11 */
#define BCHP_NAND_SPARE_AREA_WRITE_OFS_C         0x0031283c /* Nand Flash Spare Area Write Bytes 12-15 */
#define BCHP_NAND_ACC_CONTROL                    0x00312840 /* Nand Flash Access Control */
#define BCHP_NAND_CONFIG                         0x00312848 /* Nand Flash Config */
#define BCHP_NAND_TIMING_1                       0x00312850 /* Nand Flash Timing Parameters 1 */
#define BCHP_NAND_TIMING_2                       0x00312854 /* Nand Flash Timing Parameters 2 */
#define BCHP_NAND_SEMAPHORE                      0x00312858 /* Semaphore */
#define BCHP_NAND_FLASH_DEVICE_ID                0x00312860 /* Nand Flash Device ID */
#define BCHP_NAND_FLASH_DEVICE_ID_EXT            0x00312864 /* Nand Flash Extended Device ID */
#define BCHP_NAND_BLOCK_LOCK_STATUS              0x00312868 /* Nand Flash Block Lock Status */
#define BCHP_NAND_INTFC_STATUS                   0x0031286c /* Nand Flash Interface Status */
#define BCHP_NAND_ECC_CORR_EXT_ADDR              0x00312870 /* ECC Correctable Error Extended Address */
#define BCHP_NAND_ECC_CORR_ADDR                  0x00312874 /* ECC Correctable Error Address */
#define BCHP_NAND_ECC_UNC_EXT_ADDR               0x00312878 /* ECC Uncorrectable Error Extended Address */
#define BCHP_NAND_ECC_UNC_ADDR                   0x0031287c /* ECC Uncorrectable Error Address */
#define BCHP_NAND_READ_ERROR_COUNT               0x00312880 /* Read Error Count */
#define BCHP_NAND_CORR_STAT_THRESHOLD            0x00312884 /* Correctable Error Reporting Threshold */
#define BCHP_NAND_FLASH_READ_EXT_ADDR            0x00312890 /* Flash Read Data Extended Address */
#define BCHP_NAND_FLASH_READ_ADDR                0x00312894 /* Flash Read Data Address */
#define BCHP_NAND_PROGRAM_PAGE_EXT_ADDR          0x00312898 /* Page Program Extended Address */
#define BCHP_NAND_PROGRAM_PAGE_ADDR              0x0031289c /* Page Program Address */
#define BCHP_NAND_COPY_BACK_EXT_ADDR             0x003128a0 /* Copy Back Extended Address */
#define BCHP_NAND_COPY_BACK_ADDR                 0x003128a4 /* Copy Back Address */
#define BCHP_NAND_BLOCK_ERASE_EXT_ADDR           0x003128a8 /* Block Erase Extended Address */
#define BCHP_NAND_BLOCK_ERASE_ADDR               0x003128ac /* Block Erase Address */
#define BCHP_NAND_INV_READ_EXT_ADDR              0x003128b0 /* Flash Invalid Data Extended Address */
#define BCHP_NAND_INV_READ_ADDR                  0x003128b4 /* Flash Invalid Data Address */
#define BCHP_NAND_BLK_WR_PROTECT                 0x003128c0 /* Block Write Protect Enable and Size for EBI_CS0b */
#define BCHP_NAND_ACC_CONTROL_CS1                0x003128d0 /* Nand Flash Access Control */
#define BCHP_NAND_CONFIG_CS1                     0x003128d4 /* Nand Flash Config */
#define BCHP_NAND_TIMING_1_CS1                   0x003128d8 /* Nand Flash Timing Parameters 1 */
#define BCHP_NAND_TIMING_2_CS1                   0x003128dc /* Nand Flash Timing Parameters 2 */
#define BCHP_NAND_ACC_CONTROL_CS2                0x003128e0 /* Nand Flash Access Control */
#define BCHP_NAND_CONFIG_CS2                     0x003128e4 /* Nand Flash Config */
#define BCHP_NAND_TIMING_1_CS2                   0x003128e8 /* Nand Flash Timing Parameters 1 */
#define BCHP_NAND_TIMING_2_CS2                   0x003128ec /* Nand Flash Timing Parameters 2 */
#define BCHP_NAND_SPARE_AREA_READ_OFS_10         0x00312930 /* Nand Flash Spare Area Read Bytes 16-19 */
#define BCHP_NAND_SPARE_AREA_READ_OFS_14         0x00312934 /* Nand Flash Spare Area Read Bytes 20-23 */
#define BCHP_NAND_SPARE_AREA_READ_OFS_18         0x00312938 /* Nand Flash Spare Area Read Bytes 24-27 */
#define BCHP_NAND_SPARE_AREA_READ_OFS_1C         0x0031293c /* Nand Flash Spare Area Read Bytes 28-31 */
 ...
 ***************************************************************************/
#define BCHP_NAND_FLASH_CACHEi_ARRAY_BASE                          0x00312a00
