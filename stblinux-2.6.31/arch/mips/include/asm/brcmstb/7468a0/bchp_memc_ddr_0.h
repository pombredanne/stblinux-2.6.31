 ...
 *
 *
 * Date:           Generated on         Fri Sep 11 15:20:04 2009
...
/***************************************************************************
 *MEMC_DDR_0 - Memory Controller Sequencer (DDR Param/Control) Registers
 ***************************************************************************/
#define BCHP_MEMC_DDR_0_CNTRLR_CONFIG            0x002c2000 /* Memory Controller Mode-Configuration Register. */
#define BCHP_MEMC_DDR_0_DRAM_INIT_CNTRL          0x002c2004 /* Dram iniitialization control */
#define BCHP_MEMC_DDR_0_DRAM_INIT_STATUS         0x002c2008 /* Dram iniitialization status */
#define BCHP_MEMC_DDR_0_DRAM_MODE_0              0x002c200c /* Dram Mode0 register */
#define BCHP_MEMC_DDR_0_DRAM_MODE_1              0x002c2010 /* Dram Mode1 register */
#define BCHP_MEMC_DDR_0_DRAM_MODE_2              0x002c2014 /* Dram Mode2 register */
#define BCHP_MEMC_DDR_0_DRAM_MODE_3              0x002c2018 /* Dram Mode3 register */
#define BCHP_MEMC_DDR_0_PPD_CONFIG               0x002c201c /* Precharge power down mode configuration register */
#define BCHP_MEMC_DDR_0_SRPD_CONFIG              0x002c2020 /* Self-refresh power down mode configuration register */
#define BCHP_MEMC_DDR_0_SSPD_CMD                 0x002c2024 /* Software standby power down mode */
#define BCHP_MEMC_DDR_0_POWER_DOWN_STATUS        0x002c2028 /* Power down status */
#define BCHP_MEMC_DDR_0_WARM_BOOT                0x002c202c /* Warm boot control registers */
#define BCHP_MEMC_DDR_0_DRAM_TIMING_0            0x002c2030 /* DDR-SDRAM Timing Register. */
#define BCHP_MEMC_DDR_0_DRAM_TIMING_1            0x002c2034 /* DDR-SDRAM Timing Register. */
#define BCHP_MEMC_DDR_0_DRAM_TIMING_2            0x002c2038 /* Read to Write & write to read timing register */
#define BCHP_MEMC_DDR_0_DRAM_TIMING_3            0x002c203c /* DDR-SDRAM Timing Register. */
#define BCHP_MEMC_DDR_0_DRAM_TIMING_4            0x002c2040 /* DDR-SDRAM Timing Register. */
#define BCHP_MEMC_DDR_0_DRAM_TIMING_5            0x002c2044 /* DDR-SDRAM Timing Register. */
#define BCHP_MEMC_DDR_0_CNTRLR_START_SEQ         0x002c2048 /* Memory Controller Sequencer Enable */
#define BCHP_MEMC_DDR_0_CNTRLR_SM_TIMEOUT        0x002c204c /* Memory Controller , state machine timeout register. */
#define BCHP_MEMC_DDR_0_BANK_STATUS              0x002c2050 /* Memory Controller, Bank Status Register. */
#define BCHP_MEMC_DDR_0_STAT_CONTROL             0x002c2054 /* Statistics Control register */
#define BCHP_MEMC_DDR_0_STAT_TIMER               0x002c2058 /* Statistics Timer */
#define BCHP_MEMC_DDR_0_STAT_IDLE                0x002c205c /* Idle Cycle Count Register. */
#define BCHP_MEMC_DDR_0_STAT_MAX_IDLE            0x002c2060 /* Maximum idle cycle count register. */
#define BCHP_MEMC_DDR_0_STAT_CAS                 0x002c2064 /* CAS Count Register. */
#define BCHP_MEMC_DDR_0_STAT_MAX_CAS             0x002c2068 /* Maximum CAS cycle count register. */
#define BCHP_MEMC_DDR_0_STAT_SERVICE_CYCLE       0x002c206c /* Service Cycle Count register. */
#define BCHP_MEMC_DDR_0_STAT_MAX_SERVICE_CYCLE   0x002c2070 /* Maximum service cycle count register. */
#define BCHP_MEMC_DDR_0_STAT_MIN_SERVICE_CYCLE   0x002c2074 /* Minimum service cycle count register. */
#define BCHP_MEMC_DDR_0_STAT_SERVICE_TRANS       0x002c2078 /* Service Transaction Count register. */
#define BCHP_MEMC_DDR_0_STAT_MAX_SERVICE_TRANS   0x002c207c /* Maximum service Transaction count register. */
#define BCHP_MEMC_DDR_0_STAT_MIN_SERVICE_TRANS   0x002c2080 /* Minimum service cycle Transaction register. */
#define BCHP_MEMC_DDR_0_STAT_PERF                0x002c2084 /* Performance Count register. */
#define BCHP_MEMC_DDR_0_STAT_MAX_PERF            0x002c2088 /* Maximum performance count register. */
#define BCHP_MEMC_DDR_0_TESTER_LATENCY           0x002c208c /* Memory Controller, Tester Latency Register. */
#define BCHP_MEMC_DDR_0_DTPM_BYTE0               0x002c2090 /* Memory Controller, DATA_PINMAP_BYTE0_SEL Register. */
#define BCHP_MEMC_DDR_0_DTPM_BYTE1               0x002c2094 /* Memory Controller, DATA_PINMAP_BYTE1_SEL Register. */
#define BCHP_MEMC_DDR_0_DTPM_BYTE2               0x002c2098 /* Memory Controller, DATA_PINMAP_BYTE2_SEL Register. */
#define BCHP_MEMC_DDR_0_DTPM_BYTE3               0x002c209c /* Memory Controller, DATA_PINMAP_BYTE3_SEL Register. */
#define BCHP_MEMC_DDR_0_DRAM_DDR3_RESET_PERIOD   0x002c20a0 /* Memory Controller, DDR3 DRAM reset Register. */
