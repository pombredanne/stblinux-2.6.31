 ...
 *
 *
 * Date:           Generated on         Fri Sep 11 15:21:57 2009
 ...
 ***************************************************************************/
#define BCHP_BSPI_RAF_START_ADDR                 0x00313100 /* Physical Starting Address Location in Flash device */
#define BCHP_BSPI_RAF_NUM_WORDS                  0x00313104 /* Number of Words to be fetched */
#define BCHP_BSPI_RAF_CTRL                       0x00313108 /* RAF Session Control Register */
#define BCHP_BSPI_RAF_FULLNESS                   0x0031310c /* Fullness indicator for the read ahead buffer */
#define BCHP_BSPI_RAF_WATERMARK                  0x00313110 /* Watermark level in the read ahead buffer that triggers an interrupt */
#define BCHP_BSPI_RAF_STATUS                     0x00313114 /* Linear Read Status Register */
#define BCHP_BSPI_RAF_READ_DATA                  0x00313118 /* Read data from Raf-buffer */
#define BCHP_BSPI_RAF_WORD_CNT                   0x0031311c /* Current number of words fetched from Flash */
#define BCHP_BSPI_RAF_CURR_ADDR                  0x00313120 /* Current read address for the linear read session */
